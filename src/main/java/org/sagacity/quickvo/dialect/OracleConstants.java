...
public class OracleConstants {
	...
	public static final String[][] jdbcTypeMapping = {
			...
			{ "DECIMAL", "BigDecimal", "java.math.BigDecimal" }, { "BIGDECIMAL", "BigDecimal", "java.math.BigDecimal" },
			...
			{ "DATETIME", "LocalDateTime", "java.time.LocalDateTime" }, { "YEAR", "LocalDate", "java.time.LocalDate" },
