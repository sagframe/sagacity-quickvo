...
public class DefaultConstants {
	...
	public static final String[][] jdbcTypeMapping = {
			...
			{ "Int64", "BigInteger", "java.math.BigInteger" }, { "Int128", "BigInteger", "java.math.BigInteger" },
	...
	public static final String[][] jdbcAry = { { "REAL", "REAL" }, { "YEAR", "DATE" }, { "DateTime", "DATE" },
			...
			{ "Int64", "BIGINT" }, { "Int128", "BIGINT" }, { "Int256", "BIGINT" }, { "SERIAL8", "BIGINT" },
			{ "SERIAL", "INTEGER", "" }, { "BIGSERIAL", "BIGINT" }, { "Enum8", "INTEGER" }, { "Enum16", "INTEGER" },
			{ "UInt8", "INTEGER" }, { "UInt16", "INTEGER" }, { "UInt32", "INTEGER" }, { "UInt64", "BIGINT" },
			{ "UInt128", "BIGINT" }, { "UInt256", "BIGINT" }, { "FLOAT4", "FLOAT" }, { "_FLOAT4", "ARRAY" },
			{ "FLOAT8", "FLOAT" }, { "_FLOAT8", "ARRAY" }, { "FLOAT32", "FLOAT" }, { "FLOAT64", "DOUBLE" },
			{ "STRING", "VARCHAR" }, { "UUID", "VARCHAR" }, { "FixedSTRING", "VARCHAR" }, { "LONG VARGRAPHIC", "CLOB" },
